...
#! application="python stylization_script.py"
#! application="python training_script.py --style_img_name candy.jpg"
...
# CONFIG_PATH='log/kubric_multi_car/test_stability_v1/source.gin'
